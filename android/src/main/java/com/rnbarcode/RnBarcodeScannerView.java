...
public class RnBarcodeScannerView extends FrameLayout implements Camera.PreviewCallback {
    private CameraPreview mPreview;
    private MultiFormatReader mMultiFormatReader;

    private static final String TAG = "RnBarcodeScannerView";

    public RnBarcodeScannerView(Context context) {
        super(context);
